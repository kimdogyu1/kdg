...
<form name="input" action="joinAction.jsp" method="get">
	<fieldset>
	<legend style="color: lightyellow;">개인 정보 입력</legend>
	<label for='male' class = "btn btn-primary active" >남성</label>
	<input type='radio'  name="userGender" id ='male' value="male" checked>
	...
	<p>아이디&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="userID" autocomplete = "off" required></p>
	<p>패스워드&nbsp;<input type="password" name="userPassword" required></p>
